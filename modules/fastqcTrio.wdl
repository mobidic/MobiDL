task fastqc {
	...
	output {
		...
		File fastqcMotherZipR1 = "${OutDir}${SampleID}/${WorkflowType}/FastqcDir/${MotherSampleID}${Suffix1}_fastqc.zip"
		File fastqcMotherHtmlR1 = "${OutDir}${SampleID}/${WorkflowType}/FastqcDir/${MotherSampleID}${Suffix1}_fastqc.html"
		File fastqcMotherZipR2 = "${OutDir}${SampleID}/${WorkflowType}/FastqcDir/${MotherSampleID}${Suffix2}_fastqc.zip"
		File fastqcMotherHtmlR2 = "${OutDir}${SampleID}/${WorkflowType}/FastqcDir/${MotherSampleID}${Suffix2}_fastqc.html"
	}
	runtime {
		cpu: "${Cpu}"
